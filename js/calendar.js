...
function displayCalendar(){
  var monthSelectie = document.getElementById('maand');
  var yearSelectie = document.getElementById('jaar');
  var monthNames = ["January","February","March","April","May","June","July","August","September","October","November", "December"];
  var dayNames = ["Sunday","Monday","Tuesday","Wednesday","Thrusday","Friday", "Saturday"];
  var dateSelectie = monthNames[monthSelectie.value] + "," + yearSelectie.value;
  var htmlContent ="";
  var FebNumberOfDays ="";
  var counter = 1;
  var dateNow = new Date(dateSelectie);
  ...
  calendarBody += "<tr>" + htmlContent + "</tr></table>";
